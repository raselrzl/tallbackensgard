...
export default function ApartmentsNavbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-6">
        ...
        {/* Logo */}
        <Link href="/apartments" className="flex items-center md:pl-10">
          <Image
            src="/logo/logoc.png"
            alt="Logo"
            width={400}
        ...
        <div className="hidden md:flex gap-8 font-semibold text-sm uppercase">
          <Link
            href="/apartments/vara-lagenheter"
            className={linkStyle("/apartments/vara-lagenheter")}
          >
            Våra lägenheter
          </Link>
          ...
          <Link
            ...
            className={linkStyle("/apartments/kontakta-oss")}
          >
            Kontakta oss
          </Link>
