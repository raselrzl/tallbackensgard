...
export default function Lounge() {
  return (
    <section className="max-w-7xl mx-auto px-2 py-10 mb-10 font-inter" id="lounge">
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.5 }}
        className="grid md:grid-cols-2 gap-6 items-center bg-white rounded-2xl shadow-md overflow-hidden p-6"
      >
        {/* Image */}
        ...
        <div className="p-4">
          ...
          <div className="space-y-2 font-julius p-4">
